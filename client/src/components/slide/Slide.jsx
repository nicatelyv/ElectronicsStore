...
const SlideShow = () => {
    ...
    return (
        <div className='slideShow'>
            ...
            >
                <Link to={"/kicik-meiset-texnikasi"}>
                ...
                <Link to={"/mehsullar/apple-airpods-2nd-generation"}>
                    <div className="each-slide-effect">
                ...
                <Link to={"/tv-ve-audio/ses-akkustika"}>
                    <div className="each-slide-effect">
                ...
                <Link to={"/notbuk-planset-ve-komputer-texnikasi/notbuklar"}>
                    <div className="each-slide-effect">
